...
SCHEMA_DICT = {
    ...
    "tel_rec_energy": {
        "level": "dl2",
        "description": "Telescope-level reconstructed energy"
    },
    "rec_energy": {
        "level": "dl2",
    ...
    "hillas_psi": {
        "level": "simulation",
        "description": "Orientation angle of the shower ellipse"
    },
    "hillas_x": {
        "level": "simulation",
    ...
    "concentration_core": {
        "level": "simulation",
        "description": "Concentration in core pixels"
    },
    "concentration_pixel": {
        "level": "simulation",
    ...
    "morphology_n_small_islands": {
        "level": "simulation",
        "description": "Number of small islands"
    },
    ...
    "morphology_n_large_islands": {
        "level": "simulation",
        "description": "Number of large islands"
    },

    # Simulation fields - Intensity statistics
    "intensity_max": {
        "level": "simulation",
        "description": "Maximum pixel intensity in the image"
    },
    "intensity_mean": {
        "level": "simulation",
        "description": "Mean pixel intensity in the image"
    },
    "intensity_std": {
        "level": "simulation",
